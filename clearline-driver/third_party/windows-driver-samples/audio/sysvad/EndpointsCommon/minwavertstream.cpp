...
This function writes injected ClearLine PCM into the capture buffer, using
silence when user-mode has not provided enough audio.
Arguments:
...
--*/
{
    ...
    while (ByteDisplacement > 0)
    {
        ...
        ClearLineFillCaptureBuffer(m_pDmaBuffer + bufferOffset, runWrite);
